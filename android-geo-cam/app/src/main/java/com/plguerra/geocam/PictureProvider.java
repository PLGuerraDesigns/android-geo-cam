...
public class PictureProvider extends ContentProvider {
    ...
    private static String LOGTAG = "PictureProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "PhotoDB";
    // Authority is the package name
    private static final String AUTHORITY = "com.plguerra.geocam.pictureprovider";
    //TABLE_NAME is defined as PhotoList
    private static final String TABLE_NAME = "PhotoList";
    ...
    public static final String PHOTO_TABLE_COL_PHOTONAME = "TITLE";
    public static final String PHOTO_TABLE_COL_LATITUDE= "DEADLINE";
    public static final String PHOTO_TABLE_COL_LONGITUDE = "REMINDER";
    //Table create string based on column names
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            TABLE_NAME+ " " +                       // Table's name
            "(" +                           // The columns in the table
            PHOTO_TABLE_COL_ID + " INTEGER PRIMARY KEY, " +
            PHOTO_TABLE_COL_PHOTONAME + " TEXT, " +
            PHOTO_TABLE_COL_LATITUDE + " TEXT, " +
            PHOTO_TABLE_COL_LONGITUDE + " TEXT)";
